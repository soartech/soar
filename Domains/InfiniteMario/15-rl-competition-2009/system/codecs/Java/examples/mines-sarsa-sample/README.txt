=================================
RL-Glue Java MINES-SARSA-SAMPLE README
=================================
----------------------------
Introduction
----------------------------
...
This example requires the Java Codec:
...
$> java SampleSarsaAgent
$> java SampleMinesEnvironment
$> java SampleExperiment
...
$> java RunMinesSarsaExperimentNoSockets
