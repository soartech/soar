...
%  $HeadURL: http://rl-glue-ext.googlecode.com/svn/trunk/projects/codecs/Matlab/src/glue/RL_return.m $
%
function reward=RL_return()
        global p__rlglueStruct;

        doCallWithNoParams(org.rlcommunity.rlglue.codec.network.Network.kRLReturn);
        forceStandardRecv(org.rlcommunity.rlglue.codec.network.Network.kRLReturn);
